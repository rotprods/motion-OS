...
`LIVE_GITHUB_LIFECYCLE_AND_MAIN → CANONICAL_EVENT_FABRIC/IMMUTABLE_EVENTS → IDENTITY_BOUND_EVIDENCE/ARTIFACTS → CURRENT_VALIDATED_MACHINE_STATE → DERIVED_COS/CONTEXTPACK → HUMAN DOCS/TASK_PROJECTIONS`.
