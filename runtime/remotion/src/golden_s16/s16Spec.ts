export const S16_SPEC={
 ...
 authority:{sourceTiming:'MEASURED_DECODE',foregroundGeometry:'MEASURED_SOURCE_BOUND_FULL_FRAME_PROJECTION_V2',cameraBeforeUi:'PHYSICALLY_MEASURED_STATIC_PROXY',cameraAfterUi:'GLOBAL_REFLOW_CAUSE_UNKNOWN_SOURCE_LOCK_BY_DEFAULT',factorFont:'FONT_CLASS_ONLY_EXACT_FONT_UNKNOWN',columnAsset:'STRUCTURAL_APPROXIMATION_OR_SOURCE_LOCK',questionAsset:'STRUCTURAL_APPROXIMATION_OR_SOURCE_LOCK',sfxIdentity:'UNKNOWN_FROM_MIXED_MASTER',sourceFidelity:'BLOCKED_UNTIL_SOURCE_BOUND_DIFF'},
} as const;
